...
const products = [
    ...
    {
        title: "LEADER Beast 26T with Front Suspension and Disc Brake and Complete Accessories 26 T Mountain Cycle  (Single Speed, Black, Only Front Suspension)",
    ...
    {
        title: "Noise Buds VS102 Elite with 50Hr Playtime, ENC, Quad Mic, Chrome finish Flybird Design Bluetooth  (Calm Beige, True Wireless)",
    ...
    {
        title: 'Fastrack Pro with 1.43" Display & AOD(466x466), Functional Crown, BT Calling Smartwatch (Blue Strap, Free Size)',
    ...
    {
        title: "NOYMI 3D Rechargeable 100% Waterproof IPX7 Electric Shaver Wet & Dry Rotary Shavers for Men Electric Shaving Razors Trimmer, BLACK Shaver For Men (Black)",
    ...
    {
        title: "Lenovo Q-Series 60.45 cm (23.8 Inch) Full HD IPS Panel with Tilt Support, Height Adjustable, TUV Eyesafe Vision Health Board Certified, 2X3W Inbuilt Speakers, Slim Monitor (Q24i-20) (Response Time: 4 ms, 75 Hz Refresh Rate)",
    ...
    {
        title: "Egate i9 (8400 lm / 1 Speaker / Wireless / Remote Controller) Android Smart 720p Native with 1080p & 4K Support | Automatic & 4D Keystone with Netflix, Prime etc | WiFi 6 & BT, Screen Mirroring | 1GB RAM-8GB ROM Projector (White)",
